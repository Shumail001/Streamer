...
func ObjectBoxModel() *objectbox.Model {
	...
	model.RegisterBinding(EncoderModelBinding)
	model.RegisterBinding(OutputModelBinding)
	model.RegisterBinding(SrcModelBinding)
	model.RegisterBinding(RtspSrcModelBinding)
	model.LastEntityId(4, 4100077747862286081)
